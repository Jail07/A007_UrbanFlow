...
from src.constants.config import VIDEO_PATH_1, CAMERA_CONFIG_JSON_PATH_v2, LOG_FILE_PATH_V2
...
with open(LOG_FILE_PATH_V2, "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerow([
